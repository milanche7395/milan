...
<body>
    ...
    <section id="home" class="home">
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <h1><span class="gradient-text">I design & build</span>
                        digital products<span>.</span></h1>
        ...
        <div class="container">
            <div class="row my-services">
                <div class="col-md-6 left">
                    ...
                    <p>I use a wide range of techniques and tools to create high-quality websites and graphical design projects. I work, with HTML5 / CSS3 / JavaScript, jQuery, VueJS and ReactJS.</p>
                        <p>For faster results and smaller budgets I work with WordPress, Webflow and Hubspot. My SEO skills are solid, so you can be sure that your site will rank well on search engines.</p>
                </div>
                <div class="col-md-6">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="item">
                                <div class="icon-img">
                                    <img class="img-fluid" src="img/service-2.svg" alt="Applicatitions I'm fluent in">
                                </div>
                                <div class="item-content">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="item">
                                <div class="icon-img">
                                    <img class="img-fluid" src="img/service-3.svg" alt="What you can expect">
                                </div>
                                <div class="item-content">
                                    <h3>UI & UX Design</h3>
                                    <p>This is sparta</p>
